...
public class ProjektuppgiftApplication {
    ...
    @Bean
    public Game game(Scanner scanner, PlayerService playerService, GameStateManager gameStateManager,
                     IOHandler ioHandler, PlayerInteraction playerInteraction) {
        return new Game(ioHandler, gameStateManager, playerInteraction, playerService);
    }
